  ...
  */
  ...
  class CartDrawer {
    ...
    openCartDrawer() {
      ...
      document.dispatchEvent(new CustomEvent('theme:scroll:lock', {bubbles: true, detail: this.cartDrawerInner}));
      ...
      if (formWrapper.length) {
        formWrapper.forEach((element) => {
          if (variant) {
            ...
            const inputId = element.querySelector(`${selectors$v.inputId}[form]`);
            if (inputId) {
